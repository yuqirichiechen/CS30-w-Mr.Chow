...
public class SAS {
	...
	public static void binary(int [] number,int target)
	{
			...
			int center = 0;
			while(found == false && higherBund != lowerBund+1 && higherBund != lowerBund)
			{
	...
	public static void main(String[] args) {
		...
		do
		{
			...
			System.out.println("8. Sorts the list with the bubble sort");
			System.out.println("9. Sorts the list with the selection sort");
			System.out.println("10. Sorts the list with the Insertion sort");
			System.out.println("11. Sorts the list with the merge sort");
			System.out.println("12. Sorts the list with the radix sort");
			System.out.println("13. Sorts the list with the quick sort");
			...
			else if(choice == 6)
			{
				...
				System.out.println(linear(number,target));;
